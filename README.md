...
- `residue_heatmaps.py`
    ...
    ![Nine heatmaps showing the values of MoD-ART residues for three sound source positions and three energy modes, for listeners positioned throughout an environment.](/example%20environments/DampenedMiddle_20_patches/Residue_maps/Residue%20maps%20for%20band%203.png)
- `response_noiseshaping.py`
    ...
    [Listen to config. S1, L1(WAV)](/example%20environments/DampenedMiddle_20_patches/Responses/S1,%20L1.wav)
    [Listen to config. S2, L2(WAV)](/example%20environments/DampenedMiddle_20_patches/Responses/S2,%20L2.wav)
    [Listen to config. S3, L3(WAV)](/example%20environments/DampenedMiddle_20_patches/Responses/S3,%20L3.wav)
